...
g++ -c -fPIC -I "%JAVA_HOME%\include" -I "%JAVA_HOME%\include\win32" -I "%PLAYDATE_SDK_PATH%C_API" -D TARGET_EXTENSION pd4j_bridge\com_am1goo_playdate4j_sdk_DisplayBridge.cpp -o buildcache\compiled\com_am1goo_playdate4j_sdk_DisplayBridge.o
g++ -c -fPIC -I "%JAVA_HOME%\include" -I "%JAVA_HOME%\include\win32" -I "%PLAYDATE_SDK_PATH%C_API" -D TARGET_EXTENSION pd4j_bridge\com_am1goo_playdate4j_sdk_SysBridge.cpp -o buildcache\compiled\com_am1goo_playdate4j_sdk_SysBridge.o
